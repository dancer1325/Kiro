...
Source: https://kiro.dev/docs/chat/model-selection/

---

Kiro provides three powerful AI agent options to handle your development tasks: Auto, Claude Sonnet 4.0, and Claude Sonnet 4.5. Each offers distinct advantages depending on your needs and usage patterns.
Available models
Auto (recommended)
...
ModelCredit UsageExample Task CostAuto1.0x10 creditsSonnet 4.01.3x13 creditsSonnet 4.51.3x13 credits
...
Page updated: November 16, 2025ChatAutopilot