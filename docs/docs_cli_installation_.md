...
Download Kiro CLI for Linux AppImage:
...
bash# HTTP proxy for non-SSL traffic
...
bashexport HTTP_PROXY=http://username:password@proxy.company.com:8080
...
Run kiro-cli doctor to identify and fix common issues.
Check your internet connection.
Verify that you're using a supported environment. For more information, see Supported command line environments.
Try reinstalling Kiro CLI.
If the issue persists, report it using kiro-cli issue.
Page updated: November 18, 2025Authentication