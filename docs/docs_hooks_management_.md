...
Source: https://kiro.dev/docs/hooks/management/
...
Quick run: Click the play button (â·) next to the hook name in the Agent Hooks panel
From hook view: Select the hook and click Start Hook in the top-right corner
Page updated: November 16, 2025ExamplesBest practices