...
Source: https://kiro.dev/docs/getting-started/first-project/
...
Execute Tasks by clicking on individual task items
Track Progress as tasks automatically update to "In Progress" and "Done"
Loading image...
...
Page updated: November 16, 2025AuthenticationInterface