...
Source: https://kiro.dev/docs/cli/billing/contact-support/
...
You can contact billing support in two ways:Option 1: Command lineUse the Kiro CLI issue reporting command:bashkiro-cli issue
Option 2: From within chatIf you're already in a Kiro CLI chat session, you can use the built-in issue reporting tool to create a GitHub issue with pre-filled context. Just tell Kiro in natural language about the issue that you want to report, and it will help you create the issue on GitHub.Both methods will help you create a support request that gets routed to our billing team.
...
InfoFor general product questions or technical support, please refer to our documentation or visit our community forums Discord and GitHub. Billing support specifically handles account, payment, and subscription-related inquiries.
...
Page updated: November 18, 2025Related questionsOnboarding quickstart