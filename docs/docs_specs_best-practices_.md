...
.kiro/specs/
âââ user-authentication/       # Login, signup, password reset
âââ product-catalog/           # Product listing, search, filtering
âââ shopping-cart/             # Add to cart, quantity updates, checkout
âââ payment-processing/        # Payment gateway integration, order confirmation
âââ admin-dashboard/           # Product management, user analytics
...
Page updated: November 18, 2025CorrectnessChat