...
Source: https://kiro.dev/docs/editor/interface/
...
Editor - The central workspace where you write and edit code.
Chat Panel - A dedicated panel for interacting with AI, including asking questions, requesting code modifications, and receiving AI responses.
Views - The sidebar contains specialized views for managing project files, searching, and source control.
Status Bar - Provides information about the current file, Git status, and error/warning counts.
Command Palette - A quick access tool for executing common actions and accessing AI tools.
Loading image...
Editor
...
Page updated: November 16, 2025Your first projectKeyboard shortcuts