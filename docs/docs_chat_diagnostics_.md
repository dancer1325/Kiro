...
Source: https://kiro.dev/docs/chat/diagnostics/
...
Getting started
Install Language Extensions for your programming languages. See our language-specific guides for recommended extensions:
Python Guide
TypeScript/JavaScript Guide
Java Guide
Open a file in your target language to activate the language server
...
Page updated: November 16, 2025Dev serversAgent notifications