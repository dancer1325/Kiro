...
Source: https://kiro.dev/docs/cli/enterprise/billing/
...
Tier comparison
TierCreditsOveragePro1,000Opt-inPro+2,000Opt-inPower10,000Opt-in
You are billed monthly for each user that you subscribe to Kiro. For more information, see Kiro pricing.
...
Page updated: November 16, 2025SettingsIAM